...
plt.cla()
plt.title('Wykres dokladnosci od epoki')
plt.plot(training_accuracy_history, label='Dokladnosc dla danych treningowych')
plt.plot(validation_accuracy_history, label='Dokladnosc dla danych walidacyjnych')
plt.legend()
plt.ylim(0, 1)
