...
Najczęściej mylonymi klasami jest klasa NGB i NGS (rys.~\ref{fig:confusion_efficientnet_b0}).
...
Sieć często myli klasy PEB z EBO i NGB z NGS (rys. ~\ref{fig:confusion_efficientnet_b1}).
...
Kolejne epoki jedynie nieznacznie poprawiają jakość modelu (rys.~\ref{fig:plot_efficientnet_b2}).
Najczęściej mylonymi klasami są MYB i PMO (rys.~\ref{fig:confusion_efficientnet_b2}).
...
Jego wynik F1 wynosi 0.88 (wyk.~\ref{fig:plot_efficientnet_b4}). Najczęściej mylonymi klasami są MYB i PMO (rys.~\ref{fig:confusion_efficientnet_b4}).
...
Pomimo tego, że model ten zawiera więcej parametrów niż EfficientNet B4, miara F1 wynosi 0.86, co oznacza, że jego predykcje są gorsze niż w przypadku EfficientNet B4 (rys.~\ref{fig:plot_efficientnet_b5}).
Najczęściej mylonymi klasami są MYB i PMO (rys.~\ref{fig:confusion_efficientnet_b5}).
...
Najczęściej mylonymi klasami są NGB i NGS oraz MYB i PMO (rys.~\ref{fig:confusion_densenet121}).
...
Najczęściej mylonymi klasami są MON i BLA oraz MYB i PMO (rys.~\ref{fig:confusion_densenet169}).
...
Po trzeciej epoce nie występuje jednak nadmierne dopasowanie (wyk.~\ref{fig:plot_densenet201}), a najczęściej mylonymi klasami są MON i BLA oraz MYB i PMO (rys.~\ref{fig:confusion_densenet201}).
...
Najczęściej mylonymi klasami są MYB i PMO (rys.~\ref{fig:confusion_resnet18}).
