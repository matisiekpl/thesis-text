...
Nazwa \textit{Inception} pochodzi od bloku incepcji. Bloki te używają wielu warstw filtrów splotowych o różnych rozmiarach w obrębie tej samej warstwy. Pozwala to uchwycić bardziej złożone cechy obrazów w różnych skalach.
