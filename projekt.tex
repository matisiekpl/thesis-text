...
Kod źródłowy projektu był przechowywany w repozytorium na platformie GitHub. Wykresy były generowane za pomocą biblioteki \textit{matplotlib},
a metryki liczone z użyciem funkcji pakietu \textit{scikit-learn}.
