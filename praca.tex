...
\acknowledgements{\small{Niniejszą pracę pragnę zadedykować moim wspaniałym,
	\mbox{Rodzicom \textbf{Joannie i Wojciechowi Woźniak},} dzięki którym
	miałem możliwość kształcić się i zdobywać cenną wiedzę,
	którzy~stale mnie mobilizowali i wspierali przez okres trwania
	studiów na Akademii Górniczo-Hutniczej.
	\newline
	\newline
	Za inspirację, wyrozumiałość oraz pomoc przy realizacji tej
