...
mnie w całym okresie studiów,
    ...
    pragnę wyrazić serdeczne podziękowania dla \textbf{dr Macieja Błądzińskiego}.
    Jego zaangażowanie było kluczowe do zrozumienia z jakimi wyzwaniami mierzy się nowoczesna medycyna.
    \newline
    \newline
    Za wyrozumiałość, inspirację oraz pomoc pragnę złożyć serdecznie podziękowania mojemu
    promotorowi \textbf{dr Tomaszowi Hachajowi}. Jego oddanie, profesjonalizm i cenne rady stanowiły nieocenioną wartość w trakcie realizacji tego projektu.
}}
